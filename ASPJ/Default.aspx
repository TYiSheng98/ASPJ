<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ASPJ._Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Timer runat="server" Interval="2000" ID="RF" OnTick="RF_Tick"></asp:Timer>
        </ContentTemplate>
    ...
    <script>
        ...
        document.getElementById("<%= NO.ClientID %>").value;
